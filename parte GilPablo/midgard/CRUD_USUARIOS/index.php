...
<body>
    ...
    <div class="container">
                    ...
                    <?php foreach ($usuarios as $users) :?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="editarUsuario.php?username?=<?php echo $users['username'];?>&nombre=<?php echo $users['nombre'];?>"><img src="../img/pencil-square.svg"></a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                </tbody>
        ...
        <!-- ==================== MODAL USUARIO ==================== -->
        <div class="modal fade" id="usuario" tabindex="-1" aria-labelledby="modalUsuario" aria-hidden="true">
