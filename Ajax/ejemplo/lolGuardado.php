<?php 
    ...
    function ajax(){
        ...
        $con = conexion();
        $consulta="SELECT * FROM PUBLICACION WHERE id_publicacion = '$id'";
        ...
        $data = ["success"=>true,'publicacion' => $datos[0],'mensaje'=>"EXISTEN COINCIDENCIAS"];
        //$r = array_search((int)$id, array_column($datos,'id_publicacion'),true);
        // var_dump($r);

        // if($r>-1){
            
        //     //$data = ["success"=>true,'publicacion'=>$datos[$r],'mensaje'=>"EXISTEN COINCIDENCIAS"];
        // }else{
