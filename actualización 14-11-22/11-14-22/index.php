    ...
    <section class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 capa"> <!-- Alineación adaptable de Bootstrap -->
                <div class="submenu"> 
                    <a href="perfil.php"> <!-- Colocar el link a la pagina de la vista -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body"> 
                    ...
                    <input type="text" class="form-control" id="nombre"  name="nombre" placeholder="Ej: LOSCOS 1 " required>

                    <label for="ip" class="form-label mt-2">Dirección MAC</label>
