                ...
                <div class="mt-5 col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="elemento">
                        <div class="lateral">
                            ...
                            <div class="botones">
                                <button class="boton red onRed" title="Eliminar" name="<?php echo $resultado["id_publicacion"] ?>" data-bs-toggle="modal" data-bs-target="#deleteNews">
                                    <i class="fa-solid fa-trash-can"></i>
                                </button>
                                <button class="boton blue onBlue" title="Editar" name="<?php echo $resultado["id_publicacion"]; ?>" onclick="editNew();">
            ...
            <div class="modal-content">
                ...
                <form method="post" action="base.php">
                    <div class="modal-footer">
                        <button id="deleteTotal" type="submit" class="btnModal btn-success" name="newsButton">Si</button>
    ...
    <div class="modal fade modalForm" id="rechazar" tabindex="-1" aria-labelledby="modalPublicación" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- CONTENIDO DEL MODAL PUBLICACIÓN -->
                <form method="post" action="base.php" enctype="multipart/form-data" onsubmit="sendEmail();">
                    <div class="modal-body">
                    <textarea id="motivo" name="motivo" class="form-control" id="" cols="24" rows="3"></textarea>
